...
//! `PASSMAN_TPM_TESTS=1`. The pure logic — blob framing, template attributes,
...
mod tests {
    ...
    fn hardware_tests_enabled() -> bool {
        std::env::var("PASSMAN_TPM_TESTS").is_ok_and(|v| v == "1")
    }
    ...
    fn non_tpm_factors_are_declined() {
        ...
        let passphrase = SlotFactor::Passphrase {
            params: passman_core::crypto::KdfParams::insecure_fast(),
    ...
    #[test]
    #[ignore = "requires a TPM; set PASSMAN_TPM_TESTS=1"]
